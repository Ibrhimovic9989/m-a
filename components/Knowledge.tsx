        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 lg:mb-20">
          <div className="lg:col-span-6">
            ...
            <h2 className="font-display text-[40px] sm:text-[52px] lg:text-[68px] leading-[0.95] tracking-tightest font-medium">
              A working<br />
              <span className="italic font-light text-amber-dark">library,</span><br />
              kept current.
            </h2>
          </div>
          ...
          {RESOURCES.map((r, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-8">
                <span className="text-[10px] uppercase tracking-[0.24em] text-amber-dark">
                  ⌖ {r.tag}
                </span>
              ...
              <h3 className="font-display text-[22px] lg:text-[28px] leading-[1.1] tracking-tightest font-medium mb-3 text-balance">
                {r.title}
              </h3>
              <p className="text-[13px] leading-[1.55] text-ink/70 mb-6 text-balance">
                {r.body}
              </p>
